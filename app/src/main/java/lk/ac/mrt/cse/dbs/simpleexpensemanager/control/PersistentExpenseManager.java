...
public class PersistentExpenseManager extends ExpenseManager {
    public static final String DATABASE_NAME = "190152B";
    ...
    private static final String[] SQL_CREATE = {
            ...
            String.format("CREATE TABLE %s(%s int PRIMARY KEY, %s timestamp, %s text, %s text, %s real, FOREIGN KEY (%s) REFERENCES %s(%s));",
